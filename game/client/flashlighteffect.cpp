...
#ifdef NH2
		if ( (flBatteryPower <= 25.0f) || (r_flashlightforceflicker.GetBool() == true) )
		{
			if ( gpGlobals->curtime > flashlight_lastactive )
			...
			if ( (flBatteryPower <= 10.0) || (r_flashlightforceflicker.GetBool() == true) )
			{
